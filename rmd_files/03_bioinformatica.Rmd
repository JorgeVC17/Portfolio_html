...
<div>
  <img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fi.pinimg.com%2Foriginals%2Fae%2F38%2Fd8%2Fae38d86aed80887181d9d572041c4fc6.png&f=1&nofb=1&ipt=fea15f75189791247da7f564cc5044725d677e2c7f1c732117331821eb90b145&ipo=images" alt="Image" style="width: 170px; float: left; margin-right: 10px;">
  <p> My journey in bioinformatics has been driven by a passion for understanding the complexities of biological data and translating it into meaningful insights. </p>
  <p> Throughout my career, I have worked on two projects that have allowed me to apply and test my skills. From analyzing RNA-seq data to explore gene expression patterns in disease models, to studying microbial communities in diverse environments. </p>
</div>
...
![Datatree of the "RNA-sequencing" projects](~/R/html_portfolio/rmd_files/data_trees/rna.png)
...
**Autoren:** Carissa Eijking en Jorge Vargas Centeno
...
```{r Samples tabel, echo=FALSE, message=FALSE, eval=FALSE}
samples <- read_csv(here::here("projects/rna_sequencing/onecut_sampledata_OC2.csv"))
...
R1_quality <-  rasterGrob(as.raster(readPNG(here::here("projects/rna_sequencing/data/images/SRR7866699_1_fastqc_quality.png"))))
R2_quality <-  rasterGrob(as.raster(readPNG(here::here("projects/rna_sequencing/data/images/SRR7866699_2_fastqc_quality.png"))))
...
counts_dir <- "projects/rna_sequencing/data/count_tables"
...
```{r Count Statistieken, echo=TRUE, message=FALSE, eval=FALSE}
#Load read counts
counts <- readRDS("projects/rna_sequencing/count_tables/read_counts_OC2.rds")
...
```{r Count matrix, echo=TRUE, message=FALSE, eval=FALSE}
# Count matrix
...
```{r Metadata, echo=TRUE, message=FALSE, eval=FALSE}
#Import sample data
...
```{r Formule, echo=TRUE, message=FALSE, eval=FALSE}
...
```{r DESeq object, echo=TRUE, message=FALSE, eval=FALSE}
...
```{r Normalisatie, echo=TRUE, message=FALSE, eval=FALSE}
...
```{r PCA summary, echo=TRUE, eval=FALSE}
...
```{r PC1 vs PC2, echo=TRUE, eval=FALSE}
...
```{r DGE analyse, echo=TRUE, message=FALSE, eval=FALSE}
# Uitvoer DGE analyse
...
```{r Resultaten, echo=TRUE, eval=FALSE}
...
```{r Volcano Plot, echo=TRUE, eval=FALSE}
...
```{r heatmap (top_genen), echo=TRUE, eval=FALSE}
...
```{r Gen Symbolen , echo=TRUE, message=FALSE, eval=FALSE}
...
```{r heatmap (symbolen), echo=TRUE, eval=FALSE}
...
```{r Cytogenetische band, echo=TRUE, message=FALSE, eval=FALSE}
...
<div style="border: 5px dashed #FF0000; padding: 20px;">
  ...
  <p> Are you interested in using this function? Check my R package with this and even more functions! ->  https://github.com/JorgeVC17/myGOterms </p>
  <p> You can also install my R package typing the following code in your console -> devtools::install_github('https://github.com/JorgeVC17/myGOterms') </p>
</div>
...
```{r GO term functie, echo=TRUE, message=FALSE, eval=FALSE}
...
```{r Upgereguleerde genen, echo=TRUE, eval=FALSE}
#Upregulated
...
```{r Downgereguleerde genen, echo=TRUE, eval=FALSE}
#Downregulated
# Maak een dataframe met de samenvatting van de resultaten van GO term analysis
