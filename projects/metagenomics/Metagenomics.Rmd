---
title: "metagenomics_formative"
author: "Carissa Eijking & Jorge Vargas Centeno"
date: '`r Sys.Date()`'
output:
  html_document:
    theme: journal
...
fastqc -o ~/daur2/metagenomics_formatief/fastqc /home/daur2/metagenomics/formative_data/HU2_MOCK2_L001_R1_001.fastq.gz
fastqc -o ~/daur2/metagenomics_formatief/fastqc /home/daur2/metagenomics/formative_data/HU2_MOCK2_L001_R2_001.fastq.gz
...
```{r , echo=FALSE, message = FALSE, fig.height=3, out.width= '100%', fig.cap="Fig. 1: Quality distribution: Right-side) Foward read quality scores range from 0 to 40 on the Phred scale. All bases for all reads have very high quality (>30), indicating that our reads have an accuracy of >99,9%. Left-side)" }

library(png)
library(grid)
library(gridExtra)

img1 <-  rasterGrob(as.raster(readPNG("fastqc/fastqc_MOCK2_R1_per_base_quality.png")))
img2 <-  rasterGrob(as.raster(readPNG("fastqc/fastqc_MOCK2_R2_per_base_quality.png")))
...
bracken -d /home/daur2/metagenomics/minikraken2_v2_8GB_201904_UPDATE/ -i /home/carissa.eijking/daur2/metagenomics_formatief/kraken2/mock2/mock2.report -o /home/carissa.eijking/daur2/metagenomics_formatief/bracken/mock2.bracken
...
kraken-biom /home/carissa.eijking/daur2/metagenomics_formatief/kraken2/mock2/mock2_bracken_species.report --fmt json -o /home/carissa.eijking/daur2/metagenomics_formatief/kraken2/mock2/mock2_bracken_species.biom
...
data_mock2 <- "/home/carissa.eijking/daur2/metagenomics_formatief/kraken2/mock2/mock2_bracken_species.biom"
merged_metagenomes_mock2 <- import_biom(data_mock2)
```

```{r, eval = FALSE}
# inspect data format
View(merged_metagenomes_mock2@tax_table@.Data)
```
...
## **Vergelijking van resulten met compositie**
